...
// Get maxRounds from query params at init time, ensuring child components get the value immediately
...
const handleNextStep = () => {
  // Step3Simulation component handles report generation and route navigation directly
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh without fullscreen loading to prevent flicker
